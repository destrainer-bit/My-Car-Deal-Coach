...
export default function MockNegotiatorPanel(){
  ...
  async function step(){
    ...
    if (stepIndex < mockSteps.length) {
      ...
      setLog(l => [...l, {
        ...
        result: null,
        result_summary: "Mock negotiation completed. In production, this would connect to real APIs.",
        done: true,
        next_hint: "Set up real API keys to enable live negotiation assistance"
      }]);
    }
  ...
  return (
    <div style={{
      ...
      <h3 style={{ margin: '0 0 1rem 0', color: 'var(--color-primary)' }}>🤖 The Negotiator Agent (Demo Mode)</h3>
      <div style={{ 
        padding: '0.5rem', 
        ...
        <strong>Demo Mode:</strong> This is a mock demonstration. Set up API keys to enable real AI negotiation assistance.
      </div>
      <textarea 
        value={goal} 
